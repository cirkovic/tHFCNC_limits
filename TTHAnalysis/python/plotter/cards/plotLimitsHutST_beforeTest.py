...
"comb": [ 0, 0.15246 ,  0.198198 ,  0.274428 ,  0.396396 ,  0.599676 ],
...
#"comb": [ 0, 0.198198 ,  0.269346 ,  0.421806 ,  0.594594 ,  0.833448 ],
...
#"comb": [ 0, 0.108864 ,  0.159408 ,  0.244944 ,  0.357696 ,  0.493776 ],
...
#"comb": [ 0, 0.23328 ,  0.322704 ,  0.435456 ,  0.645408 ,  0.93312 ],
    }
elif postfix == "QNJet":
    results = {
      '4l'    : [6.7873, 4.0246, 5.7377, 8.8438, 14.2725, 22.653],
...
obs = ROOT.TGraphAsymmErrors(5)
exp = ROOT.TGraphAsymmErrors(5)
b68 = ROOT.TGraphAsymmErrors(5)
b95 = ROOT.TGraphAsymmErrors(5)
'''
...
frame = ROOT.TH2F("frame","frame", 100, 1e-1, 3, 6, 0, 6);
frame.GetXaxis().SetTitle("95% CL upper limit on #sigma")
#frame.GetYaxis().SetBinLabel(1, "#splitline{combined}{   #mu < %.1f (%.1f exp)}" % (results['comb'][0],results['comb'][3])  )
frame.GetYaxis().SetBinLabel(1, "comb" )
frame.GetYaxis().SetBinLabel(2, "b2j3" )
frame.GetYaxis().SetBinLabel(3, "b2j4" )
frame.GetYaxis().SetBinLabel(4, "b3j3" )
frame.GetYaxis().SetBinLabel(5, "b3j4" )
...
for i,l in enumerate(["comb","b2j3","b2j4","b3j3","b3j4"]):
#    obs.SetPoint(i, results[l][0], 0.5+i)
    exp.SetPoint(i, results[l][3], 0.5+i)
    b68.SetPoint(i, results[l][3], 0.5+i)
    b95.SetPoint(i, results[l][3], 0.5+i)
