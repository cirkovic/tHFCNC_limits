...
if [[ "$SCENARIO" != "" ]]; then
    ...
    #OPTIONS=" -P $T -j $J -l 1.65 -f  --od cards/06-11-2016 --tree tr_all_b3j4 --asimov ";
    #OPTIONS=" -P $T -j $J -l 12.9 -f  --od cards/06-11-2016 --tree tr_all_b3j4 --asimov ";
    #OPTIONS=" -P $T -j $J -l 12.9 -f  --od cards/06-11-2016 --asimov ";
    OPTIONS=" -P $T -j $J -l 7.5 -f  --od cards/06-11-2016 --asimov ";
    #OPTIONS=" -P $T -j $J -l 7.5 -f  --od cards/06-11-2016 ";
    #OPTIONS=" -P $T -j $J -l 12.9 -f  --od cards/06-11-2016 --tree tr_all_b3j4 ";
fi
...
rm cards/06-11-2016/*.root cards/06-11-2016/*.txt
...
for SIG in ST TT; do
    ...
    for c in b2j4 b3j3 b3j4; do
        ...
        #COMMAND="python makeShapeCards_modified_k.py mca_${SIG}_06-11-2016.txt cuts.txt 'MVA_TOPHLEPBB' '4,-0.6,0.6' ${OPTIONS} --tree tr_all_${c} $FTREES ${SYSTS/.txt/_}${SIG}.txt -o MVA_TOPHLEPBB_${SIG}_${c} --s2v"
        #COMMAND="python makeShapeCards_modified_k.py mca_${SIG}_06-11-2016.txt cuts.txt 'MVA_TOPHLEPBB' '6,-0.8,0.8' ${OPTIONS} --tree tr_all_${c} $FTREES ${SYSTS/.txt/_}${SIG}.txt -o MVA_TOPHLEPBB_${SIG}_${c} --s2v"
        COMMAND="python makeShapeCards_modified_k.py mca_${SIG}_06-11-2016.txt cuts.txt 'MVA_TOPHLEPBB' '20,-1.0,1.0' ${OPTIONS} --tree tr_all_${c} $FTREES ${SYSTS/.txt/_}${SIG}.txt -o MVA_TOPHLEPBB_${SIG}_${c} --s2v"
        echo $COMMAND
        eval $COMMAND &
        PSs="$PSs $!"
