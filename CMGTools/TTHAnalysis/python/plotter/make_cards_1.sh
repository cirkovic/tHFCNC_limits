...
COMMAND="python makeShapeCards_modified.py mca.txt cuts.txt 'MVA_ST_default' '10,-1.0,1.0' ${OPTIONS} $FTREES $SYSTS -o MVA_ST_default --s2v"
echo $COMMAND
eval $COMMAND

COMMAND="python makeShapeCards_modified.py mca.txt cuts.txt 'MVA_TT_default' '10,-1.0,1.0' ${OPTIONS} $FTREES $SYSTS -o MVA_TT_default --s2v"
echo $COMMAND
eval $COMMAND
...
# 0tau	
    ...
    CUT="-E ee -E 0tau"
        ...
        OMMAND="python makeShapeCards_modified.py mca.txt cuts.txt 'MVA_default' '10,-1.0,1.0' ${OPTIONS} $FTREES $SYSTS -o MVA_default --s2v"
