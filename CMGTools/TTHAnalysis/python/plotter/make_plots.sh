...
#OPTIONS=" --plotmode=norm --yrange 0.001 10 --legendFontSize 0.035"
OPTIONS=" --plotmode=nostack --yrange 0.1 100000000 --legendFontSize 0.035"
OUTPUT="~/www/${DATE}/tHFCNC/5"
rm -rf ${OUTPUT}
COMMAND="python mcPlots_modified.py -P /afs/cern.ch/work/c/cirkovic/FCNC/CMSSW_8_0_12/src/CMGTools/TTHAnalysis/macros/INPUT -j 8 -l 1.65 -f --maxRatioRange 0 3.7 --poisson ${MCA} cuts.txt plotsLogy.txt -F sf/t /afs/cern.ch/work/c/cirkovic/FCNC/CMSSW_8_0_12/src/CMGTools/TTHAnalysis/macros/FTREES/mvaVars/evVarFriend_{cname}.root --pdir ${OUTPUT} --tree tr_m $OPTIONS"
echo $COMMAND
eval $COMMAND &
...
OPTIONS=" --yrange 0.1 100000000 --legendFontSize 0.035"
